...
var PageSchema = function () {
  ...
  _createClass(PageSchema, [{
    ...
    value: function $component(src) {
      ...
      var propMap = rawProps ? function (_ref2) {
        var key = _ref2.key,
            props = _objectWithoutProperties(_ref2, ['key']);
      ...
      return function (props) {
        ...
        if (mapped && mapped.children) {
          return _react2.default.createElement(
            ...
            _this6.render({ layout: mapped.children })
          );
        }
    ...
    value: function render(_ref3) {
      ...
      var layout = _ref3.layout,
          _ref3$key = _ref3.key,
          key = _ref3$key === undefined ? generateKey('render') : _ref3$key;
      ...
      if (Array.isArray(layout)) {
        return layout.map(function (layoutItem) {
          return _this7.render({ layout: layoutItem });
        });
      }
...
var pageSchemaToReact = function pageSchemaToReact(_ref4) {
