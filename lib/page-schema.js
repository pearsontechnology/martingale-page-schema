  ...
  _createClass(PageSchema, [{
    ...
    value: function $map(src) {
      ...
      return function (data) {
        return _this4.mapValues(src, data);
      };
    }
  }, {
    key: '$mapper',
    value: function $mapper(src) {
      ...
      return function () {
        return function (data) {
          return _this5.mapValues(src, data);
        };
      };
    }
  }, {
    ...
    value: function $component(src) {
      ...
      var propMap = this.createPropMap(rawProps);
    ...
    key: 'render',
    value: function render(layout, key) {
...
var pageSchemaToReact = function pageSchemaToReact(_ref) {
  var layout = _ref.layout,
      components = _ref.components;

  var render = new PageSchema(components);
